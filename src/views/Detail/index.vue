            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="
                    add(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  computed: {
    ...
    value() {
      return this.spuSaleAttrList.spuSaleAttrValueList.reduce((p,c) => p + c.saleAttrValueName ,"")
    }
  },
  watch:{
    get() {
  ...
  methods: {
    ...
    ...mapActions(["getDetailList", "updateCartCount"]),
    // 更新图片选中的下标
